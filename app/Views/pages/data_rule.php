                    ...
                    <tbody>
                        <?php foreach ($rule as $key => $item) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning btn-sm" type="button" data-toggle="modal" data-target="#form-edit-<?php echo $item['id_rule']; ?>">
                                        <i class="fas fa-pencil-alt"> </i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-hapus-<?php echo $item['id_rule']; ?>">
...
<?php foreach ($rule as $key => $item) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="nama_gejala" class="form-control">
                                    <?php foreach ($gejala as $itemgejala) : ?>
                                        <option value="<?= $itemgejala['id_gejala'] ?>" <?= ($itemgejala['id_gejala'] == $itemgejala['id_gejala']) ? 'selected' : '' ?>>
    ...
    <!-- Modal hapus data -->
    <div class="modal fade" id="modal-hapus-<?php echo $item['id_rule']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
